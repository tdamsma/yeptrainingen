  ...
  .container-fluid.p-0.m-0
    ...
    .jumbotron.bg-white.m-0
      ...
      .jumbotron.jumbotron.bg-white.m-0
        .row
          .col-lg-4
            enhanced:img.fluid(sizes="min(1280px, 100vw)" style="max-width: 100%; height: auto" src="/static/images/anna-stutje.jpg" alt="Anna Stutje - YEP trainingen coach")
      ...
      enhanced:img.fluid(sizes="min(1280px, 100vw)" style="max-width: 100%; height: auto" src="/static/images/site-foto-1-of-1-3.jpg" alt="YEP trainingen - coaching omgeving")
</template>
