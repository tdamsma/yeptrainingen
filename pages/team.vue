    ...
    <div class="container">
     ...
     <div class="container">
        <div class="row justify-content-around mb-1">
          <div class="col-md-3 mt-4 py-3 bg-white">
            <b-img
              fluid="fluid"
              blank-color="#777"
      ...
      <div class="row justify-content-around mb-4">
          <div class="col-md-3 mt-4  py-3 bg-white">
            ...
            <h2 class="text-center mt-1">Sarah van der Vlerk</h2> Ik ben regisseur, trainingsacteur en trainer. Ik vind het belangrijk om inspirerende trainingen te geven, waar je naar buiten loopt met nieuwe ideeën en een frisse blik. Maar ik ben ook een praktische trainer, ik geef concrete handvatten waar je mee aan de slag kunt. Ik geloof in een actieve aanpak, in mijn trainingen wordt niet veel stilgezeten. Door te doen, te experimenteren en te ervaren leer je mijns inziens meer dan door alleen te luisteren.
          </div>
          <div class="col-md-3 mt-4 py-3 bg-white">
            <b-img
              fluid="fluid"
              blank-color="#777"
              src="~/assets/images/team/Eline_Hoebe_06.jpg"
              :srcset="require(`~/assets/images/team/Eline_Hoebe_06.jpg?sizes[]=200&amp;sizes[]=200`).srcSet" 
            >
            </b-img>
            <h2 class="text-center mt-1">Eline Hoebe</h2>Ik geloof sterk in de kracht van ervarend leren. Fietsen leer je immers ook niet door er een boek over te lezen. Als trainingsacteur en trainer laat ik je op een speelse manier ervaren wat je eigen invloed kan zijn om het gewenste effect te bereiken in het contact met de ander.  Wat mij drijft is om het volledige potentieel van een professional naar boven te halen door het ontwikkelen van persoonlijk leiderschap, zodat je zelfbewuster een betekenisvolle bijdrage levert aan jezelf, je werkomgeving en de wereld om je heen.
          </div>
          <div class="col-md-3 mt-4 py-3 bg-white">
            <b-img
              fluid="fluid"
              blank-color="#777"
              src="~/assets/images/team/Rianda.jpg"
              :srcset="require(`~/assets/images/team/Rianda.jpg?sizes[]=200&amp;sizes[]=200`).srcSet" 
            >
            </b-img>
            <h2 class="text-center mt-1">Rianda van der Meer</h2>
          </div>
          <div class="col-md-3 mt-4 py-3 bg-white">
            <b-img
              fluid="fluid"
              blank-color="#777"
              src="~/assets/images/team/sophie-van-oers.jpg"
              :srcset="require(`~/assets/images/team/sophie-van-oers.jpg?sizes[]=200&amp;sizes[]=200`).srcSet" 
            >
            </b-img>
            <h2 class="text-center mt-1">Sophie van Oers</h2>Wat ik ervaar in de groep en van een individu, benut ik zo veel mogelijk in de training.
          </div>
        </div>
      </div>
