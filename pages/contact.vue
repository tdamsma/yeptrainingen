  ...
  <div>
    ...
    <div class="container_fluid mt-6 p-4 bg-white">
      <div class="container">
        <form
          id="mc4wp-form-1"
          class="mc4wp-form mc4wp-form-1369 mc4wp-form-theme mc4wp-form-theme-green"
          method="post"
          data-id="1369"
        ...
        >
          <div class="mc4wp-form-fields">
            <H2> Nieuwsbrief</H2>
            <p>Blijf op de hoogte en meld je aan voor onze Nieuwsbrief (ongeveer 1x per kwartaal)</p>
